package com.learning.systemdesign.foundations.layeredarchitecture.user.repository;
 ...
 */
@Repository("com.learning.systemdesign.foundations.layeredarchitecture.user.repository.UserRepository")
