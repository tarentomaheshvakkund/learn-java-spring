...
import com.learning.step1.Shape;
...
public class SwitchPatternExample {
  ...
  public double getArea(Shape shape) {
    ...
    return switch (shape) {
      case com.learning.step1.Circle c -> Math.PI * Math.pow(c.calculateArea() / Math.PI, 1); // Simplistic reuse
      case com.learning.step1.Rectangle r -> r.calculateArea();
      case com.learning.step1.Square s -> s.calculateArea();
